...
var musicContainer = document.getElementById('music-container'),
    ...
    cover = document.getElementById('cover'); // Song titles

var songs = ['hey', 'summer', 'ukulele']; // Keep track of songs

var songIndex = 2; // Intially load song details into DOM

loadSong(songs[songIndex]); // Update song details

function loadSong(song) {
  title.innerHTML = song;
  audio.src = "./assets/music/".concat(song, ".mp3");
  cover.src = "./assets/img/".concat(song, ".jpg");
} // Play song
...
function setProgress(e) {
  ...
  var width = this.clientWidth; // 位置を取得

  var clickX = e.offsetX;
  var duration = audio.duration; // console.log(clickX);
...
audio.addEventListener('timeupdate', updateProgress); // Click on progess bar
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "ef91315bb88849893bdd"; }
/******/ 	}();
/******/ 	
