...
function addTransactionDOM(transaction) {
  ...
  item.innerHTML = "\n    ".concat(transaction.text, " <span>").concat(sign).concat(Math.abs(transaction.amount), "</span> <button class=\"delete-btn\" id=\"delete-btn\" onclick=\"removeTransaction(").concat(transaction.id, ")\">x</button>\n  ");
...
function updateValues() {
  ...
  balance.innerText = "\xA5".concat(total);
  money_plus.innerText = "\xA5".concat(income);
  money_minus.innerText = "\xA5".concat(expense); // console.log(expense);
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "6d2a4cceec28136aacf4"; }
/******/ 	}();
/******/ 	
